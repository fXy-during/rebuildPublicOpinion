...
class Handled extends React.Component {
  ...
  //  初始化state
  initState(state) {
    const { handledCondition, feedbackCondition, id, detail } = !!state
      ? state.data[0]
      : this.props.data[0];
    this.setState(
      {
        handledCondition: Array.isArray.call(handledCondition)
          ? handledCondition
          : handledCondition.split("/"),
        feedbackCondition,
        id,
        detail
      },
      ...
      <div>
        ...
        <div className="connect-btn-container">
          ...
          <Button
            ...
            onClick={this.handleHandleAction.bind(this)}
          >
            处置
          </Button>
        </div>
